...
function showInstructions()
 ...
 if mode[index] == "100% Catch" and showInstructionsText then
  ...
  gui.text(emuWindow.leftPadding + 1, emuWindow.topPadding + 72, "4) Advance one frame holding SELECT and then unpause the")
 ...
 elseif mode[index] == "Initial Seed Bot" and showInstructionsText then
  ...
  gui.text(emuWindow.leftPadding + 1, emuWindow.topPadding + 54, "3) Advance one frame holding SELECT")
 ...
 elseif mode[index] == "TID Bot" and showInstructionsText then
  ...
  gui.text(emuWindow.leftPadding + 1, emuWindow.topPadding + 72, "4) Advance one frame holding START")
