...
function main()
 ...
 if mode[index] ~= "None" and mode[index] ~= "Pokemon Info" then
  ...
  if mode[index] == "C-Gear" then
   gui.text(0, 103, string.format("Next C-Gear: %08X", buildSeed()))
   gui.text(0, 113, string.format("Delay: %d", delay))
   gui.text(0, 123, string.format("C-Gear Seed: %08X", hitMtSeed))
   gui.text(0, 133, string.format("Hit Delay: %d", hitDelay))
