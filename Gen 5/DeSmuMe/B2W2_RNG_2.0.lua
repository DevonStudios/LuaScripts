...
function main()
 ...
 gui.text(0, 0, string.format("Initial Seed: %08X%08X", initSeedHigh, initSeedLow))
 gui.text(0, 10, string.format("Current Seed: %08X%08X", currSeedHigh, currSeedLow))
 gui.text(0, 20, string.format("PID Frame: %d", frame))
 gui.text(0, 30, string.format("IVs Frame: %d", ivsFrame))
 gui.text(195, 0, string.format("%02d/%02d/%d", month, day, 2000 + year))
 gui.text(207, 10, string.format("%02d:%02d:%02d", hour, minute, second))
