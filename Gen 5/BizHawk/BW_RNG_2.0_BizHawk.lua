...
while true do
 ...
 gui.text(0, 383, "Mode: "..mode[index])
 gui.text(200, 383, "<- 1 - 2 ->")
 gui.text(0, 405, string.format("Initial Seed: %08X%08X", initSeedHigh, initSeedLow))
 gui.text(0, 420, string.format("Current Seed: %08X%08X", currSeedHigh, currSeedLow))
 gui.text(0, 435, string.format("PID Frame: %d", frame))
 gui.text(0, 450, string.format("IVs Frame: %d", ivsFrame))

 if mode[index] == "C-Gear" then
  gui.text(0, 540, string.format("Next C-Gear: %08X", buildSeed()))
